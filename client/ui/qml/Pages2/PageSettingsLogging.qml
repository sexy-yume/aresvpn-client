...
PageType {
    ...
    QtObject {
        ...
        readonly property string description: qsTr("AresVPN Client logs")
    ...
    QtObject {
        ...
        readonly property string description: qsTr("AresVPN Client service logs")
        ...
        readonly property var exportLogsHandler: function() {
            ...
            fileName = SystemController.getFileName(qsTr("Save"),
                                                    qsTr("Logs files (*.log)"),
                                                    StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/AresVPNClient-service",
                                                    true,
                                                    ".log")
            if (fileName !== "") {
                PageController.showBusyIndicator(true)
